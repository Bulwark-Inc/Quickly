...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  var createSVGElement = ([tag, attrs, children2]) => {
    ...
    if (children2?.length) {
      children2.forEach((child2) => {
        const childElement = createSVGElement(child2);
  ...
  function Slide$1(Splide2, index, slideIndex, slide) {
    ...
    var on2 = event.on, emit = event.emit, bind3 = event.bind;
  ...
  function Move2(Splide2, Components2, options) {
  ...
  function Controller(Splide2, Components2, options) {
    ...
    var Move3 = Components2.Move;
    var getPosition = Move3.getPosition, getLimit = Move3.getLimit, toPosition = Move3.toPosition;
    ...
    function go(control, allowSameIndex, callback) {
      if (!isBusy()) {
        ...
        if (index > -1 && (allowSameIndex || index !== currIndex)) {
          setIndex(index);
          Move3.move(dest, index, prevIndex, callback);
        }
      }
    }
    function scroll(destination, duration, snap, callback) {
      Components2.Scroll.scroll(destination, duration, snap, function() {
        var index = loop2(Move3.toIndex(getPosition()));
    ...
    function toDest(destination) {
      var closest2 = Move3.toIndex(destination);
  ...
  function Arrows(Splide2, Components2, options) {
    var event = EventInterface(Splide2);
    var on2 = event.on, bind3 = event.bind, emit = event.emit;
  ...
  function Scroll2(Splide2, Components2, options) {
    var _EventInterface8 = EventInterface(Splide2), on2 = _EventInterface8.on, emit = _EventInterface8.emit;
    var set3 = Splide2.state.set;
    var Move3 = Components2.Move;
    var getPosition = Move3.getPosition, getLimit = Move3.getLimit, exceededLimit = Move3.exceededLimit, translate = Move3.translate;
    var isSlide = Splide2.is(SLIDE);
    var interval;
    var callback;
    var friction = 1;
    ...
    function scroll(destination, duration, snap, onScrolled, noConstrain) {
      ...
      if (snap && (!isSlide || !exceededLimit())) {
        ...
        destination = Move3.toPosition(Components2.Controller.toDest(destination % size2)) + offset;
      }
  ...
  function Drag(Splide2, Components2, options) {
    ...
    var state = Splide2.state;
    var Move3 = Components2.Move, Scroll3 = Components2.Scroll, Controller2 = Components2.Controller, track2 = Components2.Elements.track, reduce = Components2.Media.reduce;
  ...
  function Slide(Splide2, Components2, options) {
    var Move3 = Components2.Move, Controller2 = Components2.Controller, Scroll3 = Components2.Scroll;
    ...
    function start2(index, done) {
      var destination = Move3.toPosition(index, true);
      var position = Move3.getPosition();
      var speed = getSpeed(index);
      if (abs(destination - position) >= 1 && speed >= 1) {
        if (options.useScroll) {
          Scroll3.scroll(destination, speed, false, done);
        } else {
          transition2("transform " + speed + "ms " + options.easing);
          Move3.translate(destination, true);
          endCallback = done;
        }
      } else {
        Move3.jump(index);
